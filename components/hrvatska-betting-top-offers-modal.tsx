      ...
      <DialogContent className="w-[90vw] max-w-[480px] p-0 bg-white border-2 border-journal-charcoal shadow-2xl">
        ...
        <div className="bg-white px-6 py-6">
          ...
          <div className="flex flex-col items-center justify-center gap-4 mb-5 pb-5 border-b border-gray-200">
            <div className="relative items-center flex bg-black p-2 h-36 w-60 rounded border border-gray-200 overflow-hidden">
              <Image src={topSite.logo || "/placeholder.svg"} alt={topSite.name} width={400} height={300} className="object-contain p-2 mx-auto" />
            </div>
            <div>
